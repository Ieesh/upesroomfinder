...
public class MyActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private final static String MY_EMAIL = "xyz@gmail.com";
    private final static String EMAIL_SUBJECT = "BUG REPORT UPESROOMFINDER";

    private Spinner buildingSpinner, daySpinner, hourSpinner;
    private static final String[] buildings = {"ninethblock", "tenthblock", "eleventhblock"};
