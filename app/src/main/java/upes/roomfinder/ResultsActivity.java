        ...
        for (int i = 0; i < allClassrooms.size(); i++, timeIndexer++) {
            ...
            for (int k = 0; k < timesList.size(); k++) {
                ...
                if ("5".equalsIgnoreCase(String.valueOf(timesList.get(k).toString().charAt(12)))) {
                    endTime++;
                } else if ("1".equalsIgnoreCase(String.valueOf(timesList.get(k).toString().charAt(12)))) {
                    endTime++; //some classes end at ##:15, currently I do not know how to treat these so I'm going to round up.
                }
